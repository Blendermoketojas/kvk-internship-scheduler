        ...
        apiClient
          ...
          .then((response) => {
            if (Array.isArray(response.data)) {
              // Map the internships to the desired format
              this.internships = response.data.map((internship) => {
                // Assume that the first user profile relates to the internship
        ...
        apiClient
          ...
          .then((response) => {
            ...
            if (response.data && Array.isArray(response.data.internships)) {
              ...
              // Handle the case where internships array is not present
